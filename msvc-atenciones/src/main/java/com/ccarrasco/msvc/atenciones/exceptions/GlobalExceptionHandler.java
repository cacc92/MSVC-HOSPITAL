package com.ccarrasco.msvc.atenciones.exceptions;


import com.ccarrasco.msvc.atenciones.dtos.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleMedicoException(AtencionException exception){

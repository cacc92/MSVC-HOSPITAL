...
public class Medico {
    ...
    @Schema(description = "Codigo del medico", example = "1")
    ...
    @Schema(description = "Rut del medico", example = "11222333-4")
    private String runMedico;

    @Column(name = "nombre_completo", nullable = false)
    @NotBlank(message = "El campo nombre completo medico no puede ser vacio")
    @Schema(description = "Nombre completo del medico", example = "Carlos Juan Bodoque Perez")
    private String nombreCompleto;

    @Schema(description = "Especialidad del medico", example = "Pediatria")

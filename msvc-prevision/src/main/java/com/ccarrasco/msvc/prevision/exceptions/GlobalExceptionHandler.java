package com.ccarrasco.msvc.prevision.exceptions;


import com.ccarrasco.msvc.prevision.dtos.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PrevisionException.class)
    public ResponseEntity<ErrorDTO> handlePrevisionException(PrevisionException exception){
